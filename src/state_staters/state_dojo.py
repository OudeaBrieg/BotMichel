...
# State Setter for building Custom Training Environment
class DojoState(StateSetter):
    def __init__(self,
                 difficulty_list = {
                    "distance" : 0,
                    "car_yaw" : 0,
    ...
    def reset(self, state_wrapper: StateWrapper):
        ...
        # Cars Initialization
        car_distance = get_difficulty_distance(self.difficulty_list["distance"])
        car_yaw = get_difficulty_car_yaw(self.difficulty_list["car_yaw"], car_distance, fw_bw)
        car_speed = get_difficulty_car_speed(self.difficulty_list["car_speed"], fw_bw)
